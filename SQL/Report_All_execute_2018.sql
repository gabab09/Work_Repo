SET @start_date = '2018-03-11 23:59:59'; 
SET @end_date = '2018-03-15 00:00:00'; 
...
case 
	...
	when ((tkt_resolved.AlertType = 'Host') AND ((tkt_resolved.Service is NULL) OR (tkt_resolved.Service = '')) AND (tkt_resolved.TicketOrigin = 'IPmonAlert'))
		then 'HostDown'	
...
where
tkt_resolved.ClientName != "IPsoft"
